        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-100">
            <tr>
              ...
              <th className="px-4 py-3 text-center text-xs font-medium text-gray-700 uppercase tracking-wider" style={{ width: '120px' }}>
                Actions
              </th>
            </tr>
          </thead>
                ...
                <td className="px-4 py-4 text-center" style={{ width: '120px' }}>
                  <div className="flex items-center justify-center space-x-2">
                    ...
                    <button
                      ...
                      className="flex items-center justify-center text-sm font-medium rounded-full p-2 transition-colors duration-200 text-blue-600 hover:text-blue-900 hover:bg-blue-50"
                      title="Copy item"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
