...
export default function SAPromotionsQuotation() {
  const [quotation, setQuotation] = useState<QuotationData>({
    quotationNumber: `SA-Q-${new Date().getFullYear()}-${String(Date.now()).slice(-6)}`,
  ...
  // Force recalculate all item amounts on component load
      ...
      items: prev.items.map(item => {
        if (item.id === id) {
          ...
          if (field === 'qty' || field === 'price') {
            ...
            if (qty > 0 && price > 0) {
              let calculatedAmount = qty * price;
              // Apply rounding to individual item amounts if enabled
              if (quotation.roundOff) {
                calculatedAmount = Math.round(calculatedAmount);
              }
  ...
  // Force recalculation on component mount
  React.useEffect(() => {
    recalculateAllItems();
  }, []);

  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-purple-100 p-4 md:p-6">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <header className="bg-white rounded-xl shadow-xl p-6 md:p-8 mb-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center mb-6 md:mb-0">
              <div className="bg-gradient-to-r from-purple-500 to-pink-500 text-white p-4 rounded-lg mr-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
              </div>
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-gray-800">SA Promotions</h1>
                <p className="text-purple-600 mt-1">Create Professional Quotations</p>
              </div>
            </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      className="w-16 border border-gray-300 rounded px-2 py-1 text-center focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                      min="0"
                      max="100"
                      step="0.1"
                    />
      ...
      {showPDFModal && (
        <PDFPreviewModal
          ...
          data={{
            ...quotation,
            companyName: "SA Promotions",
            companyAddress: "Plot no. 24-25, PU-4, Cabin 10, Platinum Plaza, Behind C21 Mall, Indore - 452011",
            companyPhone: "+91 7314256776, +91 9826300300",
            companyEmail: "sapromotions@marketinggmail.com",
            companyGST: "SA-GST-NUMBER",
            // Use SA Promotions specific letterhead images
            headerImage: "/sapromtion-header.jpg",
            footerImage: "/sapromotion-footer.jpg",
            signatureImage: "/sapromtion-seal.jpg"
          }}
