...
export default function ChallanList() {
  const [challans] = useState(mockChallans);
      ...
      <div className="max-w-6xl mx-auto bg-white rounded-xl shadow-xl p-6 md:p-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 border-b pb-6">
          <div className="flex items-center mb-4 md:mb-0">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Challan List</h1>
          </div>
          <div className="flex space-x-3">
            <Link
              href="/challan/create"
              className="bg-orange-600 text-white px-4 py-2 rounded-lg hover:bg-orange-700 transition-colors duration-200 flex items-center shadow-md"
            >
        ...
        {challans.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900">No challans</h3>
            <p className="mt-1 text-sm text-gray-500">Get started by creating a new challan.</p>
            <div className="mt-6">
              <Link
                href="/challan/create"
