...
export default function RudharmaQuotation() {
  // Initialize with Rudharma Enterprises details
  const [quotation, setQuotation] = useState<QuotationData>({
    quotationNumber: `RE-Q-${new Date().getFullYear()}-${Math.floor(1000 + Math.random() * 9000)}`,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-50 to-sky-100 p-4 md:p-6">
      {/* PDF Preview Modal */}
      <PDFPreviewModal
        ...
        data={{
          ...
          companyAddress: "133 Metro Green Society, Saddu Raipur - 492113",
          companyPhone: "+91-9981122131",
          companyEmail: "rudharmaaenterprises@gmail.com",
          companyGST: "22APMPR8089K1Z3",
          headerImage: "/rudharma-header.jpg",
          footerImage: "/rudharma-footer.jpg",
          signatureImage: "/rudharma-signature.jpg",
        }}
      />
      ...
      <div className="max-w-6xl mx-auto bg-white rounded-xl shadow-xl p-6 md:p-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 border-b pb-6">
          <div className="flex items-center mb-4 md:mb-0">
            <div className="bg-sky-600 text-white p-3 rounded-lg mr-4">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
              </svg>
            </div>
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Rudharma Enterprises</h1>
              <p className="text-sky-600 font-semibold mt-1">Quotation System</p>
            </div>
          </div>
          <div className="flex space-x-3">
            <button
              onClick={generatePDF}
              className="bg-sky-600 text-white px-4 py-2 rounded-lg hover:bg-sky-700 transition-colors duration-200 flex items-center shadow-md"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div className="bg-sky-50 p-6 rounded-xl shadow-sm">
            <h2 className="text-lg font-semibold mb-4 text-sky-800 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="block w-full border border-gray-300 rounded-lg shadow-sm p-3 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition-all duration-200"
                />
              </div>
              <div>
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 mb-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-3">
            <div className="flex items-center">
              ...
              <span className="ml-2 bg-sky-100 text-sky-800 text-xs font-medium px-2.5 py-0.5 rounded">
            ...
            <div className="flex space-x-2">
              ...
              <button
                type="button"
                onClick={addItem}
                className="bg-sky-600 text-white px-4 py-2 rounded-lg hover:bg-sky-700 transition-colors duration-200 flex items-center shadow-sm"
              >
          ...
          {showAddColumn && (
            <div className="mb-6 p-4 bg-sky-50 rounded-lg border border-sky-200 shadow-sm">
              <h3 className="text-sm font-medium text-sky-800 mb-3">Add a Custom Column</h3>
              <div className="flex flex-col sm:flex-row items-center gap-3">
                <div className="w-full">
                  <input
                    ...
                    className="w-full border border-sky-300 rounded-lg p-3 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition-all duration-200"
                  />
                </div>
                <button
                  type="button"
                    ...
                    <th key={column.id} className="px-4 py-3 text-left text-xs font-medium text-white uppercase tracking-wider relative group">
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className="ml-2 text-sky-200 hover:text-white opacity-0 group-hover:opacity-100 transition-opacity"
                          title="Remove column"
                        >
                  ...
                  <tr key={item.id} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                    ...
                    <td className="px-4 py-3">
                      <input
                        ...
                        className="block w-full border border-gray-300 rounded-lg p-2 shadow-sm focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition-all duration-200"
                    ...
                    <td className="px-4 py-3">
                      <input
                        ...
                        className="block w-full border border-gray-300 rounded-lg p-2 shadow-sm focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition-all duration-200 text-right"
                        min="0"
                        step="0.01"
                        placeholder="0.00"
                      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-gray-50 rounded-xl p-6 shadow-md border border-gray-200">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between pb-2 border-b border-gray-200">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="w-16 border border-gray-300 rounded p-1 mr-2 text-center focus:ring-2 focus:ring-sky-500 focus:border-sky-500"
                    min="0"
                    max="100"
                  />
              ...
              <div className="flex justify-between items-center pt-2">
                ...
                <span className="text-lg font-bold text-sky-600">₹{formatIndianNumber(quotation.total || 0)}</span>
              </div>
          ...
          <div className="space-y-6">
            <div className="bg-sky-50 rounded-xl p-4 shadow-sm border border-gray-200">
